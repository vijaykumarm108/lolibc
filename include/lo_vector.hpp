...
#include "memory"
#include "lo_upredalgo.h"
#include "lo_uctrstrm.h"

namespace std {

/// \class vector vector std.h
/// \ingroup Sequences
///
...
{
    resize (v.size());
    ::lo::std::copy (v.begin(), v.end(), begin());
}
