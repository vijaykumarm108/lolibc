...
/// \class istream LoMistream.h std.h
...
public:
    ...
    inline off_t	tellg (void) const	{ return (off_t)(pos()); }
...
///
/// \brief An iterator over an istream to use with std algorithms.
///
