...
typedef struct _OPTPARAM {
    ...
    LPWSTR      pData;          // pointer to the data
...
typedef struct _EXTPUSH {
    ...
    LPWSTR              pTitle;         // extended push botton title
    union {
...
typedef struct _EXTCHKBOX {
    ...
    LPWSTR      pTitle;         // extended checkbox title
    LPWSTR      pSeparator;     // pointer to separator string for treeview
    LPWSTR      pCheckedName;   // string to be displayed when checked
    ULONG_PTR   IconID;         // icon to be used
...
typedef struct _CPSUICBPARAM {
    ...
    union {
        ...
        LPWSTR  pOldSel;            // Last selection (pStr)
        } DUMMYUNIONNAME;
...
typedef struct _COMPROPSHEETUI {
    ...
    LPWSTR          pCallerName;        // pointer to the caller's name
    ULONG_PTR       UserData;           // caller's own data
    ...
    ULONG_PTR       IconID;             // icon to be used
    LPWSTR          pOptItemName;       // pointer to the optitem's data name
