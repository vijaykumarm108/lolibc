...
/// \class exception uexception.h std.h
/// \ingroup Exceptions
///
/// \brief Base class for exceptions, equivalent to lo::std::exception.
///
#if WITHOUT_LIBSTDCPP
class exception {
#else
class exception : public lo::std::exception {
#endif
public:
...
/// \class bad_cast uexception.h std.h
/// \ingroup Exceptions
///
...
/// \class bad_alloc uexception.h std.h
/// \ingroup Exceptions
///
...
#else
class bad_alloc : public lo::std::bad_alloc, public exception {
#endif
public:
...
/// \class libc_exception uexception.h std.h
/// \ingroup Exceptions
///
...
/// \class file_exception uexception.h std.h
/// \ingroup Exceptions
///
...
/// \class stream_bounds_exception uexception.h std.h
/// \ingroup Exceptions
///
