...
namespace lo {
	...
	/// \param start   Offset at which to start filling the linked block
	/// \param p       Pointer to the pattern.
	/// \param elSize  Size of the pattern.
	/// \param elCount Number of times to write the pattern.
